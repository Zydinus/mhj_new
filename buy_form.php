  ...
  <body>
    ...
    <div class="container">
            ...
            <div class="panel-body">
              ...
              <script type="text/javascript">
                ...
                function addProductRow() {
                  ...
                  switch (currentCustomer.buy_price_level) {
                    case "1":
                      originalPrice = selectedProduct.buy_price_1;
                      break;
                    case "2":
                      originalPrice = selectedProduct.buy_price_2;
                      break;
                    case "3":
                      originalPrice = selectedProduct.buy_price_3;
                      break;
                  }
                  ...
                  var col7 = "<td>"+$("#p_quantity_b").val()+"</td>";
                  var col8 = "<td>"+(100*parseFloat(discount))+"%</td>";
                  var col9 = "<td>"+totalPrice+"</td>";
        ...
        <div class="col-lg-9">
          ...
          <p>
            <table class="table table-hover table-striped table-bordered" id="tableProduct">
              ...
              <tfoot>
                <tr>
                  <th colspan="8"><?= s2("product_total") ?></th>
                  <th id="total">
                  </th>
                </tr>
                <tr>
                  <th colspan="8"><?= s2("tax_vat") ?></th>
                  <th id="vat">
                  </th>
                </tr>
                <tr>
      ...
      <div class="row">
        <div class="col-lg-12">
          <p class="text-center">
            <a href="buy_start.php" role="button" class="btn btn-default btn-lg">
              <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
              <?= s2("cancel") ?>
            </a>
            <button id="btnSubmit" type="button" class="btn btn-danger btn-lg" onclick="javascript:submitBuy()">
